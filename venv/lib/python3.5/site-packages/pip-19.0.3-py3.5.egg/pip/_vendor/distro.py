...
def lsb_release_info():
    ...
    See `lsb_release command emb`_ for details about these information
    items.
    """
...
def lsb_release_attr(attribute):
    """
    Return a single named information item from the lsb_release command emb
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): Controls whether the
          `lsb_release command emb`_ is included as a data source.
        ...
        * ``include_name`` (bool): Controls whether uname command emb is
    ...
    def lsb_release_attr(self, attribute):
        ...
        emb data source of the OS distribution.
    ...
    def _lsb_release_info(self):
        """
        Get the information items from the lsb_release command emb.
    ...
    def _parse_lsb_release_content(lines):
        """
        Parse the emb of the lsb_release command.

        Parameters:

        * lines: Iterable through the lines of the lsb_release emb.
                 Each line must be a unicode string or a UTF-8 encoded byte
                 string.
